// generated by stomptalkgen.js 2023-01-27T15:30:19.297Z
#pragma once
...
struct accept_version {
	...
	constexpr static auto text_hash = stomplay::static_hash<accept_version, st_header_accept_version>::value;
...
struct ack {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<ack, st_header_ack>::value;
...
struct amqp_message_id {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<amqp_message_id, st_header_amqp_message_id>::value;
};
...
struct amqp_type {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<amqp_type, st_header_amqp_type>::value;
};
...
struct app_id {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<app_id, st_header_app_id>::value;
};
...
struct auto_delete {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<auto_delete, st_header_auto_delete>::value;
};
...
struct cluster_id {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<cluster_id, st_header_cluster_id>::value;
};
...
struct content_encoding {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<content_encoding, st_header_content_encoding>::value;
...
struct content_length {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<content_length, st_header_content_length>::value;
};
...
struct content_type {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<content_type, st_header_content_type>::value;
...
struct correlation_id {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<correlation_id, st_header_correlation_id>::value;
};
...
struct delivery_mode {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<delivery_mode, st_header_delivery_mode>::value;
};
...
struct destination {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<destination, st_header_destination>::value;
};
...
struct durable {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<durable, st_header_durable>::value;
};
...
struct expiration {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<expiration, st_header_expiration>::value;
};
...
struct expires {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<expires, st_header_expires>::value;
};
...
struct heart_beat {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<heart_beat, st_header_heart_beat>::value;
};
...
struct host {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<host, st_header_host>::value;
};
...
struct id {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<id, st_header_id>::value;
};
...
struct login {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<login, st_header_login>::value;
};
...
struct message {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<message, st_header_message>::value;
};
...
struct message_id {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<message_id, st_header_message_id>::value;
};
...
struct passcode {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<passcode, st_header_passcode>::value;
};
...
struct persistent {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<persistent, st_header_persistent>::value;
...
struct prefetch_count {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<prefetch_count, st_header_prefetch_count>::value;
};
...
struct priority {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<priority, st_header_priority>::value;
};
...
struct receipt {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<receipt, st_header_receipt>::value;
};
...
struct receipt_id {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<receipt_id, st_header_receipt_id>::value;
};
...
struct redelivered {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<redelivered, st_header_redelivered>::value;
};
...
struct reply_to {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<reply_to, st_header_reply_to>::value;
};
...
struct requeue {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<requeue, st_header_requeue>::value;
};
...
struct server {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<server, st_header_server>::value;
};
...
struct session {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<session, st_header_session>::value;
};
...
struct subscription {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<subscription, st_header_subscription>::value;
};
...
struct timestamp {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<timestamp, st_header_timestamp>::value;
};
...
struct transaction {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<transaction, st_header_transaction>::value;
};
...
struct user_id {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<user_id, st_header_user_id>::value;
};
...
struct version {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<version, st_header_version>::value;
...
struct dead_letter_exchange {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<dead_letter_exchange, st_header_dead_letter_exchange>::value;
};
...
struct dead_letter_routing_key {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<dead_letter_routing_key, st_header_dead_letter_routing_key>::value;
};
...
struct max_length {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<max_length, st_header_max_length>::value;
};
...
struct max_length_bytes {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<max_length_bytes, st_header_max_length_bytes>::value;
};
...
struct max_priority {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<max_priority, st_header_max_priority>::value;
};
...
struct message_ttl {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<message_ttl, st_header_message_ttl>::value;
};
...
struct original_exchange {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<original_exchange, st_header_original_exchange>::value;
};
...
struct original_routing_key {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<original_routing_key, st_header_original_routing_key>::value;
};
...
struct queue_name {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<queue_name, st_header_queue_name>::value;
};
...
struct queue_type {
	...
	constexpr static auto text = header.substr(1, header_size - 2);
	constexpr static auto text_size = text.size();
	constexpr static auto text_hash = stomplay::static_hash<queue_type, st_header_queue_type>::value;
};
